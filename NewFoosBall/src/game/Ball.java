...
public class Ball {
	...
	{
		try {
			this.image = ImageIO.read(new File("res/football.png"));
		} catch (IOException e) {
...
//		}
	...
	public void draw(Graphics2D g)
	{
		...
		g.drawImage(this.image, this.ballPosition.getX(), 
				this.ballPosition.getY(),this.silhouette.height * 2, this.silhouette.width * 2, null);
