...
public class totalNoOfPLayersEqualToElevenTeamA {
	public Game init() {
	...
	@Test
	public void totalNoOfPlayersEqualToZeroTeamA() {
		Game game = init();
		int i,totalPlayers=0;
		for(i=0;i<4;i++) {
			totalPlayers += game.getField().getTeamA().getSticks()[i].getNoOfPlayers();
		}
